/**
 * Generate poster.png 1024×1024 for Kiss Wall.
 * Hero kiss mark + emerging rose silhouette + Cormorant italic title.
 *
 * Run: node gen_poster.cjs → writes public/poster.png + games/posters/kiss-wall.png
 */
...
const OUT_LIST = '/Users/yin/code/games/games/posters/kiss-wall.png';
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .pitch {
    ...
    font-weight: 500;
    font-size: 26px;
    color: rgba(240, 238, 219, 0.88);
    margin-top: 12px;
  }
  /* AlterU emblem mark bottom-right */
  .emblem {
    position: absolute;
      ...
      <svg class="bg" viewBox="0 0 200 300" preserveAspectRatio="none">
        <defs>
          ...
          <mask id="reveal" maskUnits="userSpaceOnUse">
            ...
            <!-- mask circles roughly where the kisses land -->
            <circle cx="100" cy="70"  r="26" fill="url(#brush)"/>
            <circle cx="80"  cy="100" r="26" fill="url(#brush)"/>
            <circle cx="120" cy="100" r="26" fill="url(#brush)"/>
            <circle cx="100" cy="140" r="26" fill="url(#brush)"/>
            <circle cx="80"  cy="170" r="26" fill="url(#brush)"/>
            <circle cx="120" cy="170" r="26" fill="url(#brush)"/>
            <circle cx="100" cy="200" r="26" fill="url(#brush)"/>
            <circle cx="80"  cy="230" r="26" fill="url(#brush)"/>
            <circle cx="120" cy="230" r="26" fill="url(#brush)"/>
          </mask>
        </defs>
        <rect x="0" y="0" width="200" height="300" rx="10" ry="10" fill="url(#sheen)"/>
        <rect x="0" y="0" width="200" height="300" rx="10" ry="10" fill="url(#side)"/>
        <!-- rose silhouette behind kisses -->
