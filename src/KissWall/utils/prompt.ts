...
// Locked aesthetic — every piece has to look like it lives in the same
// shelf as silh-bust.png / silh-rose.png / silh-eye.png.
const STYLE_BASE =
...
const SUBJECT_BY_SILHOUETTE: Record<SilhouetteId, string> = {
  skull:
    'A polished bone-coloured memento mori skull, three-quarter side view, '
    + 'perfect anatomical accuracy, slight ivory cracks across the cranium, '
    + 'jaw intact and slightly parted, no teeth missing, '
    + 'CG sculpture render aesthetic, no neck, no body, only the skull.',
  heart:
    'A single anatomical human heart specimen, deep crimson and ox-blood '
    + 'red, wet glossy surface, aortic arch and ventricles fully visible, '
    + 'photoreal medical-illustration feel, no body, just the heart in space.',
  bust:
    'A pure white marble bust of a serene young woman in classical Greco-Roman '
    + 'style, three-quarter portrait angle, carved hairline curls and a calm '
    + 'closed-eye expression, plinth visible at the base, hand-carved studio '
    + 'sculpture photograph, no clothing visible below the shoulders.',
  eye:
    'A single hyper-realistic close-up human eye, macro detail, '
    + 'fully detailed iris with brown-to-amber tones, wet lower lash line, '
    ...
    + 'cinematic close-up.',
  hand:
    'A single pale outstretched human hand, palm facing the viewer, '
    + 'photoreal skin detail, faint lifelines, no arm visible above the wrist, '
    + 'no jewellery, no nail polish, the hand fades into pitch black at the wrist, '
    + 'vertical orientation.',
  rose:
    'A single full-bloom dark crimson rose with deep emerald leaves and a '
  ...
  veil:
    'A translucent black mourning lace veil falling vertically with delicate '
    + 'floral lace embroidery and a thin gold thread along the edge, '
    + 'soft folds catching a single rim light, no figure inside the veil, '
    + 'no face, just the fabric as a hanging specimen, photoreal textile detail.',
  wings:
    'A single dusty white feathered wing in profile, photoreal feather-by-feather '
    + 'detail, slight ash-gray tinge toward the tips, no body or shoulder attached, '
...
export function buildPortraitPrompt(input: PortraitPromptInput): PortraitPrompt {
  ...
  const body = [
    ...
    'COLOUR: keep the subject\'s natural palette (do NOT force monochrome), let the natural hues sit against the black.',
  ].join(' ');
